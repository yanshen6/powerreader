...
public class UtilTools {
	 public static boolean isGpsEnabled(LocationManager locationManager) {
		  ...
		  return false;
		     ...
		     * @throws Exception 
		     */
		    public static Location callGear(Context ctx, ArrayList<LocCellInfo> cellIds) throws Exception {
		     String result="";
		  ...
		  try {
		   result = UtilTools.getResponseResult(ctx, "http://www.google.com/loc/json", cellIds);
		   ...
		   loc.setTime(UtilTools.getUTCTime());
		   return loc;
		  ...
		  * 请求路径：http://maps.google.cn/maps/geo?key=abcdefg&q=26.0673834,119.3119936
		     ...
		     * @throws Exception
		     */
		 public static String getResponseResult(Context ctx,String path, ArrayList<LocCellInfo> cellInfos)
		  ...
		  InputStream inStream=UtilTools.sendPostRequest(path, 
		    getRequestParams(cellInfos), "UTF-8");
		  if(inStream!=null){
		   byte[] datas=UtilTools.readInputStream(inStream);
		  ...
		  * @return
		  */
		 public static String getRequestParams(List<LocCellInfo> cellInfos){
		  ...
		  if(cellInfos!=null&&cellInfos.size()>0){
		   ...
		   for(LocCellInfo cellInfo:cellInfos){
		    sb.append("{");
		  ...
		  * @return
		  */
		 public static ArrayList<LocCellInfo> init(Context ctx) {
		  ArrayList<LocCellInfo> cellInfos = new ArrayList<LocCellInfo>();
		  ...
		  * @param tm
		  */
		 private static void cdma(ArrayList<LocCellInfo> cellInfos, TelephonyManager tm) {
		  
			 try
			 {
				 CdmaCellLocation location = (CdmaCellLocation) tm.getCellLocation();
			 
		  LocCellInfo info = new LocCellInfo();
		  ...
		  * @param tm
		  */
		 private static void mobile(ArrayList<LocCellInfo> cellInfos,
		   TelephonyManager tm) {
		  ...
		  * @param tm
		  */
		 private static void union(ArrayList<LocCellInfo> cellInfos, TelephonyManager tm) {
		  GsmCellLocation location = (GsmCellLocation)tm.getCellLocation();  
		  LocCellInfo info = new LocCellInfo();
